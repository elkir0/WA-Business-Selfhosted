...
test('repository layout — required files exist', () => {
  const required = [
    ...
    'src/lib/csrf.js',
    'src/lib/admin-audit.js',
    'src/admin/App.jsx',
    'src/admin/main.jsx',
    'src/admin/style.css',
    'src/admin/lib/api.js',
    'src/admin/lib/format.js',
    ...
    'src/admin/pages/Conversations.jsx',
    'src/admin/pages/ConversationDetail.jsx',
    'src/admin/pages/Contacts.jsx',
    'src/admin/pages/FailedForwards.jsx',
    'src/admin/pages/System.jsx',
    'src/admin/pages/Audit.jsx',
    'scripts/set-password.js',
    'vite.config.mjs',
    'db/migrations/0010-admin-ui.sql',
    'db/schema.sql',
    'docs/deployment.md',
    'docs/meta-setup.md',
    'docs/plugins.md',
